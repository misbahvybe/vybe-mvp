-- Idempotent: (re)creates missing objects without failing if they already exist.
-- Use this if 20260410150000 was recorded but tables never appeared, or FKs were missing.
