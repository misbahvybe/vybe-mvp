  ...
  return (
    <div className="min-h-screen bg-primary-dark flex flex-col items-center justify-center px-4 sm:px-8 w-full min-w-0">
      <div className="text-center w-full max-w-sm sm:max-w-md">
        <h1 className="text-2xl sm:text-3xl font-bold text-white">Become a Rider</h1>
        <p className="mt-2 text-white/85 text-sm sm:text-base">Login with your rider account to start accepting deliveries.</p>
